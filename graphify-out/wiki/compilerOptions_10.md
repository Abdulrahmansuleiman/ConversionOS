...
> God node · 16 connections · `bloomline-dashboard/tsconfig.node.json`

**Community:** [compilerOptions](compilerOptions.md)

## Connections by Relation

### contains
- bloomline-dashboard/tsconfig.node.json `EXTRACTED`
- lib `EXTRACTED`
