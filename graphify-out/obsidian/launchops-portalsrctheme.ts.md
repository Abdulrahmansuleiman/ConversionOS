...
## Connections
- [[ASSET_TYPES]] - `contains` [EXTRACTED]
- [[Documents.tsx]] - `imports_from` [EXTRACTED]
- [[Feedback.tsx]] - `imports_from` [EXTRACTED]
- [[LoginScreen.tsx]] - `imports_from` [EXTRACTED]
- [[Overview.tsx]] - `imports_from` [EXTRACTED]
- [[PHASES]] - `contains` [EXTRACTED]
- [[PROJECT_STATUSES]] - `contains` [EXTRACTED]
...
- [[launchops-portalsrccomponentsSidebar.tsx]] - `imports_from` [EXTRACTED]
- [[launchops-portalsrccomponentsui.tsx]] - `imports_from` [EXTRACTED]
- [[launchops-portalsrcstylesGlobalStyles.ts]] - `imports_from` [EXTRACTED]
- [[phaseStatusColor]] - `contains` [EXTRACTED]
