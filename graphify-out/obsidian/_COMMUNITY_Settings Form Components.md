...
## Members
- [[ErrorBox_1]] - code - pipeline-dashboard/src/tabs/SettingsTab.tsx
- [[ErrorState()_1]] - code - pipeline-dashboard/src/components/ErrorState.tsx
- [[ErrorStateProps_1]] - code - pipeline-dashboard/src/components/ErrorState.tsx
- [[Field_1]] - code - pipeline-dashboard/src/tabs/SettingsTab.tsx
- [[FieldError_1]] - code - pipeline-dashboard/src/tabs/SettingsTab.tsx
...
```dataview
TABLE source_file, type FROM #community/Settings_Form_Components
SORT file.name ASC
```
...
## Top bridge nodes
- [[pipeline-dashboardsrctabsSettingsTab.tsx]] - degree 30, connects to 5 communities
- [[pipeline-dashboardsrccomponentsErrorState.tsx]] - degree 12, connects to 4 communities
- [[ErrorState()_1]] - degree 8, connects to 4 communities
- [[Pill_1]] - degree 2, connects to 1 community