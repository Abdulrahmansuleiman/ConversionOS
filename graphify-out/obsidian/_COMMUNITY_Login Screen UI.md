...
- [[LoginScreen()]] - code - launchops-portal/src/components/LoginScreen.tsx
- [[LoginScreen.tsx]] - code - launchops-portal/src/components/LoginScreen.tsx
...
```dataview
TABLE source_file, type FROM #community/Login_Screen_UI
SORT file.name ASC
```
...
- [[LoginScreen()]] - degree 2, connects to 1 community